/* globals Bacon, d3, ffmapConfig, linkColor, loadNodes, pacman */
//TODO: remove no-unused-vars config, once switched to modules
/*eslint no-unused-vars: [2, {"vars": "local"}] */
//TODO: don't require use strict for this file, because it has too many anonymous functions
//switching to requirejs will make this more easy, disabling strict test, for now
/*eslint strict: 0 */
var style
...
if (!ffmapConfig.showstats)
  d3.select("#firmware").style("display","none")
...
function update() {
  ...
  node.attr("class", function(d) {
        var s = ["node"]
        if (ffmapConfig.checkfirmware && !d.firmware)
          s.push(["legacy"])
