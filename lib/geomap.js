/* globals L, d3, linkColor, loadNodes, ffmapConfig */
...
function update(data) {
  ...
  var geocoordsZoom = /.*?\?lat=([0-9]{0,3}\.[0-9]*)&lon=([0-9]{0,3}\.[0-9]*)&z=([0-9]{1,2})$/
  if ( geocoords.exec(document.URL) != null )
    map.setView(L.latLng(RegExp.$1,RegExp.$2),map.getMaxZoom())
  else if ( geocoordsZoom.exec(document.URL) != null && RegExp.$3 >= map.getMinZoom() && RegExp.$3 <= map.getMaxZoom() )
      map.setView(L.latLng(RegExp.$1,RegExp.$2), RegExp.$3)
  else
